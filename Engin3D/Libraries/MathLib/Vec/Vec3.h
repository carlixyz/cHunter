...
struct cVec3 {
	...
	static inline cVec3 Zero();
	static inline cVec3 One();
	static inline cVec3 Foward();
	static inline cVec3 Back();
	static inline cVec3 Up();
	static inline cVec3 Down();
	static inline cVec3 Right();
	static inline cVec3 Left();
...
inline cVec3 cVec3::Zero()
{
	return cVec3(0.0f, 0.0f, 0.0f);
}
inline cVec3 cVec3::One()
{
	return cVec3(1.0f, 1.0f, 1.0f);
}
inline cVec3 cVec3::Foward()
{
	 return cVec3(0.0f, 0.0f, 1.0f);
}
inline cVec3 cVec3::Back()
{
	return cVec3(0.0f, 0.0f, -1.0f);
}
inline cVec3 cVec3::Up()
{
	return cVec3(0.0f, 1.0f, 0.0f);
}
inline cVec3 cVec3::Down()
{
	return cVec3(0.0f, -1.0f, 0.0f);
}
inline cVec3 cVec3::Right()
{
	return cVec3(1.0f, 0.0f, 0.0f);
}
inline cVec3 cVec3::Left()
{
	return cVec3(-1.0f, 0.0f, 0.0f);
}
